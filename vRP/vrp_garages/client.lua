...
local garages = {
	...
	{name="Garage", colour=3, id=357, x=-53.398, y=-1117.79, z=25.433, h=0.0},
	{name="House Garage", colour=3, id=357, x=-623.26617431641, y=56.52184677124, z=42.730266571045, h=0.0}, --2487.5964355469,4960.4428710938,44.829174041748
	{name="Garage", colour=3, id=357, x=2487.596, y=4960.442, z=40.000, h=0.0}, --2487.5964355469,4960.4428710938,44.829174041748
	{name="Garage", colour=3, id=357, x=782.334, y=-295.623, z=58.88156, h=0.0}, --favela
	{name="Garage", colour=3, id=357, x=275.9407043457, y=-324.92849731445, z=43.919876098633, h=0.0},
	{name="Garage", colour=3, id=357, x=1247.9842529297, y=2715.4938964844, z=37.005790710449, h=0.0}, ---623.26617431641,56.52184677124,43.730266571045
	{name="Garage", colour=3, id=357, x=-3150.6652832031, y=1058.9271240234, z=19.624845504761, h=0.0},
	{name="Garage", colour=3, id=357, x=1764.8997802734, y=3650.3969726563, z=33.492790222168, h=0.0},
	{name="Garage", colour=3, id=357, x=1395.1678466797, y=1118.2042236328, z=113.83770751953, h=0.0},
	{name="Garage", colour=3, id=357, x=22.734422683716, y=544.39080810547, z=175.02755737305, h=0.0},
	{name="Garage", colour=3, id=357, x=166.29052734375, y=-1275.5360107422, z=28.052066802979, h=0.0},
	{name="Garage", colour=3, id=357, x=-1525.8486328125, y=-552.94549560547, z=31.822204589844, h=0.0},
	{name="Garage", colour=3, id=357, x=-806.36700439453, y=162.6949005127, z=71.542282104492, h=0.0},
	{name="Garage", colour=3, id=357, x=-1068.912109375, y=675.43029785156, z=142.29064941406, h=0.0},
}
	...
	function vRPgt.spawnGarageVehicle(vtype, name, vehicle_plate, vehicle_colorprimary, vehicle_colorsecondary, vehicle_pearlescentcolor, vehicle_wheelcolor, vehicle_plateindex, vehicle_neoncolor1, vehicle_neoncolor2, vehicle_neoncolor3, vehicle_windowtint, vehicle_wheeltype, vehicle_mods0, vehicle_mods1, vehicle_mods2, vehicle_mods3, vehicle_mods4, vehicle_mods5, vehicle_mods6, vehicle_mods7, vehicle_mods8, vehicle_mods9, vehicle_mods10, vehicle_mods11, vehicle_mods12, vehicle_mods13, vehicle_mods14, vehicle_mods15, vehicle_mods16, vehicle_turbo, vehicle_tiresmoke, vehicle_xenon, vehicle_mods23, vehicle_mods24, vehicle_neon0, vehicle_neon1, vehicle_neon2, vehicle_neon3, vehicle_bulletproof, vehicle_smokecolor1, vehicle_smokecolor2, vehicle_smokecolor3, vehicle_modvariation, vehicle_bodyhp, vehicle_enginehp) -- vtype is the vehicle type (one vehicle per type allowed at the same time)
		...
		if vehicle == nil then
			...
			if HasModelLoaded(mhash) then
				...
				if tonumber(vehicle_bodyhp) == 1000 then
					vehicle_bodyhp = 1000.0
				end
				if tonumber(vehicle_bodyhp) < 0 then
					vehicle_bodyhp = 0.0
				end
				if tonumber(vehicle_enginehp) == 1000 then
					vehicle_enginehp = 1000.0
				end
				if tonumber(vehicle_enginehp) < 0 then
					vehicle_enginehp = 0.0
				end
				SetVehicleBodyHealth(nveh, vehicle_bodyhp)
				SetVehicleEngineHealth(nveh, vehicle_enginehp)
			...
			vRP.notify({"Você pode apenas ter um "..vtype.." veículo fora da Garagem."})
		end
	end
	...
	function vRPgt.despawnGarageVehicle(vtype,max_range)
		...
		if vehicle then
			...
			if GetDistanceBetweenCoords(x,y,z,px,py,pz,true) < max_range then -- check distance with the vehicule
				...
				vRP.notify({"~r~Você não possui um veículo pessoal fora da Garagem."})
			end
		end
		...
		function SellVehicle(vehID)
			local vehID = vehID
			TriggerServerEvent('ply_garages:SellVeh', vehID)
			CloseMenu()
		end
